...
class Sensor(Node):
	...
	def __init__(self):
		...
		self.ang_subscriber = self.create_subscription(String, 'Ang', self.angular_callback, 10)
		self.ang1_subscriber = self.create_subscription(String, 'Ang1', self.angular1_callback, 10)		
